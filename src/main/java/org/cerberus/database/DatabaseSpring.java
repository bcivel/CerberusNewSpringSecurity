...
public class DatabaseSpring {
    ...
    public Connection connect() {
        try {
            ...
            LOG.warn("Cannot connect to datasource jdbc/cerberus" + env + " : " + exception.toString());
        }
    ...
    public void closeConnection() {
        ...
        if (this.conn != null) {
            try {
                ...
                LOG.warn("Can't end/close the connection to datasource jdbc/cerberus" + env + " : " + ex.toString());
            }
        }
