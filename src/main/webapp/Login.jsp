            ...
            <div class="col-md-6 panel panel-default panel-login" >
                ...
                <div class="col-md-12 login-box-form">
                    ...
                    <div class="col-md-6">
                        ...
                        <form method="post" action="./login" id="login-box">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="username" name="username" class="form-control" title="Username" placeholder="Username" value="" size="50" maxlength="50" aria-describedby="user-icon" autofocus>
                                </div>
                            </div>
                            <div class="form-group">
                                <label>
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="password" autocomplete class="form-control" type="password" placeholder="Password" title="Password" value="" size="30" maxlength="20">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <button id="Login" name="Login" class="btn btn-primary col-md-6 col-xs-12 pull-right" value="Submit" alt="Submit">Login</button>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
